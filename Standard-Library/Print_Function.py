...
#Outputs to console whatever you put in print parenthesis
print()
...
#CONCATENATION
#One can print two different sentences and put them together
...
print('MP',3)
#In this example, one won't be able to use "+" instead of ",". That's beacause strings and int numbers are two differente types of data

#To use the plus symbol with a string and a number, one has to convert the number into a string
print('MP '+str(5))
...
#One can't convert a float number into a int number
